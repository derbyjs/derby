...
model.fn('_page.leaders', 'players', 'cutoff', function (players, cutoff) {
...
# players are added and removed, their scores change, and the
# cutoff value changes.
model.fn '_page.leaders', 'players', 'cutoff', (players, cutoff) ->
  # Note that the input array is copied with slice before sorting
  # it. The function should not modify the values of its inputs.
...
model.ref('_page.selectedColor', 'colors', 'selected');
// Logs '#f00'
console.log(model.get('_page.selectedColor.hex'));
...
model.ref('_page.myColors', 'colors', '_page.colorIds');

...
function parseViewElement(element) {
  ...
  var remaining, viewPointer;
  if (nameAttribute.template) {
    remaining = element.content;
    viewPointer = new templates.DynamicViewPointer(nameAttribute.template, viewAttributes);
  } else {
    ...
    viewPointer = new templates.ViewPointer(name, viewAttributes);
  }
...
function viewAttributesFromElement(element) {
  ...
  for (var key in element.attributes) {
    ...
    viewAttributes[key] = (attribute.template) ?
      new templates.ParentWrapper(attribute.template) : attribute.data;
  }

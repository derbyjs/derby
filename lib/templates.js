...
util.mergeInto(exports, saddle);

exports.View = View;
exports.ViewPointer = ViewPointer;
exports.DynamicViewPointer = DynamicViewPointer;
...
View.prototype.get = function(context, unescaped) {
  if (this.componentFactory) {
    context = this.componentFactory.create(context);
  }
...
View.prototype.getFragment = function(context, binding) {
  ...
  var template = this.template || this._parse();
  return template.getFragment(context, binding);
};
...
ParentWrapper.prototype.get = function(context, unescaped) {
  return this.expression.get(context.parent, unescaped);
};
...
Views.prototype.register = function(name, source, options) {
  var view = new View(this, name, source, options);

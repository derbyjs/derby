...
function patchCtx(ctx, triggerPath) {
  var meta = ctx.$paths[0];
  var path = meta && meta[0];
  ...
  // If the last segment is the specific value/item that will be rendered then this will not be a part of triggerPath and thus we need to compensate to avoid overwriting that index (right?)

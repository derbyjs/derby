...
function WrapperExpression(value) {
  this.value = value;
  this.meta = null;
}
WrapperExpression.prototype = new Expression();
WrapperExpression.prototype.get = function(context) {
  return this.value;
};
...
function Context(meta, model, parent, expression, unbound, item, at, attributes) {
  this.meta = meta;
  this.model = model;
  this.parent = parent;
...
Context.prototype.viewChild = function(at, attributes) {
  return new Context(this.meta, this.model, this, this.expression, this.unbound, null, at, attributes);
};

...
BracketsExpression.prototype._resolveInside = function(context) {
  var inside = this.inside.get(context);
  if (inside == null || inside === '') {
    return ['$null'];
  }
  return inside.toString().split('.');
};
BracketsExpression.prototype._resolveFull = function(context, insideSegments) {
...
BracketsExpression.prototype.resolve = function(context) {
  var insideSegments = this._resolveInside(context);
  return this._resolveFull(context, insideSegments);
};
BracketsExpression.prototype.dependencies = function(context) {
  var insideSegments = this._resolveInside(context);
  var segments = this._resolveFull(context, insideSegments);
  return [segments, insideSegments];
};

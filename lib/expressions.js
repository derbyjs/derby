...
function Context(meta, model, parent, expression, unbound, at, item) {
  this.meta = meta;
  this.model = model;
  this.parent = parent;
...
Context.prototype.viewChild = function(at) {
  return new Context(this.meta, this.model, this, this.expression, this.unbound, at);
};

...
function createComponent(context, componentContext, parent, attributes) {
  var id = context.id();
...
ComponentFactory.prototype.init = function(context) {
  ...
  var component = createComponent(context, componentContext, context.controller, context.attributes);
...
SingletonComponentFactory.prototype.init = function(context) {
  var componentContext = context.componentChild();
  var component = this.component || createComponent(context, componentContext);

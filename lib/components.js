...
Component.prototype.destroy = function() {
  ...
  delete this.page._eventModel.object.$components.object[this.id];
};
...
function initComponent(context, component, parent, model, id, scope) {
  // set the "closest path" (if any) to be accessible from templates
  model.set('$path', context.getClosestPath());

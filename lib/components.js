...
function Component(id, parent, context) {
  this.id = id;
  this.parent = parent;
...
Component.prototype.get = function(viewName) {
...
Component.prototype.getView = function(viewName) {
  ...
  return (viewName) ?
    this.app.views.find(viewName, contextView.namespace) :
    this.app.views.find(contextView.namespace);
};
...
function initComponent(component, context, componentContext, attributes) {
  ...
  Component.call(component, id, parent, componentContext);

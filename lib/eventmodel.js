...
EventModel.prototype.isEmpty = function() {
  if (! this._isEmpty(this.dependancies)) return false;
  if (! this._isEmpty(this.itemContexts)) return false;

  if (this.object) {
    if (this._isEmpty(this.object)) return false;
    this.object = null;
  }
...
EventModel.prototype._isEmpty = function(obj) {
  for (var k in obj) {
    return false;
  }
  return true;

...
function createComponent(view, model, ns, name, boundMacro, scope, ctx) {
  ...
  if (type === 'partial') {
    return function(ctx, model, triggerPath, triggerId, value, index, listener) {
      ...
      if (alias) {
        ...
        createComponent(view, model, name[0], name[1], boundMacro, scope, renderCtx);
      } else {

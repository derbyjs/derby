...
//
// Exposed as a `view.make` method. Populates `this._views`.
...
// Exposed as a `view._makeAll` method
...
// Accessible to the outside world as a `View.prototype._makeComponents`, not
// used in this module.

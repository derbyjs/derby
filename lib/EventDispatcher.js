var EventDispatcher = exports = module.exports = function(onTrigger, onBind) {
  this._onTrigger = onTrigger || function() {};
  this._onBind = onBind || function() { return true; };
...
EventDispatcher.prototype = {
  ...
  _trigger: function(name, value, options) {
    ...
    Object.keys(listeners).forEach(function(key) {
      ...
      if (onTrigger(listener, value, options) === false) {

...
function init(derby, app) {
    ...
    if (partial) {
      ...
      if (method === 'insert') {
        ...
        for (var i = index; i < end; i++) {
          value += partial(listener.ctx, model, triggerId, values[i], i, listener) || '<!--empty-->';
        }
      } else {
  ...
  model.on('remove', '**', function derbyOnRemove(path, index, removed, pass) {
    ...
    triggerParents(path, 'remove', pass);
  });
  ...
  function triggerEach(path, arg0, arg1, arg2, arg3, arg4) {
    ...
    triggerParents(path, arg0, arg1, arg2, arg3, arg4);
  }

  function triggerParents(path, arg0, arg1, arg2, arg3, arg4) {

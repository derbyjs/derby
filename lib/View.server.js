...
View.prototype._loadBundle = function(callback) {
  ...
  var view = this;
  if (isProduction) {
    if (this.bundleAndTemplates) return callback(null, this.bundleAndTemplates, this.bundleMap);
  } else if (this.bundle) {
    var view = this;
    var fileInfo = files.parseName(this._appFilename);
    loadTemplates(function(err) {
      if (err) return callback(err);
      var bundleAndTemplates = view.bundle + '\n' + templatesScript +
        '\n//# sourceMappingURL=' + view._scriptMapPath;
      callback(null, bundleAndTemplates, view.bundleMap);
    });
    return;
  }
  ...
  async.parallel([loadTemplates, loadScripts], function(err) {
    ...
    view.bundleAndTemplates = view.bundle + '\n' + templatesScript +
      '\n//# sourceMappingURL=' + view._scriptMapPath;
    callback(null, view.bundleAndTemplates, view.bundleMap);
  });

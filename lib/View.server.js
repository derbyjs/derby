...
//
// `root` is a string, set to an absolute path to a directory containing `lib`
// and `views` directories.
//
// `clientName` is usually an `app`, derived from path `lib/app/index.js`.
//
// Used only from `View.prototype._load` function and `refresh.server` module.

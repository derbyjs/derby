...
function loadLibrary(libraries, libraryName, libraryData, finish) {
  files.library(libraries[libraryName].root, function(err, components) {
...
View.prototype._loadTemplates = function(root, clientName, callback) {
  ...
  for (libraryName in libraries) {
    loadLibrary(libraries, libraryName, libraryData, finish)
  }
};
...
View.prototype._initValues = function(model) {
  ...
  for (name in libraries) {
    libraries[name].view._initValues(model);
  }
};
